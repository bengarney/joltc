...
namespace JoltPhysics
{
    public static unsafe partial class JoltC
    {
        ...
        [DllImport(__DllName, EntryPoint = "jpc_JPH_BodyLockInterface_TryGetBody", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern JPH_Body* JPH_BodyLockInterface_TryGetBody(JPH_BodyLockInterface* lockInterface, uint bodyID);
        ...
        [DllImport(__DllName, EntryPoint = "jpc_JPH_DebugRenderer_SetCameraPos", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void JPH_DebugRenderer_SetCameraPos(JPH_DebugRenderer* renderer, JPH_Vec3* cameraPos);
        ...
        [DllImport(__DllName, EntryPoint = "jpc_JPH_EstimateCollisionResponse", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void JPH_EstimateCollisionResponse(JPH_Body* a, JPH_Body* b, JPH_ContactManifold* manifold, JPH_CollisionEstimationResult* result, float inCombinedFriction, float inCombinedRestitution, float inMinVelocityForRestitution, int inNumIterations);
    ...
    {
        public JPH_Vec3 mLinearVelocity1;
        public JPH_Vec3 mAngularVelocity1;
        public JPH_Vec3 mLinearVelocity2;
        public JPH_Vec3 mAngularVelocity2;
        public JPH_Vec3 mTangent1;
        public JPH_Vec3 mTangent2;
        public int ImpulseCount;
        public fixed float ContactImpulse[64];
        public fixed float FrictionImpulse1[64];
        public fixed float FrictionImpulse2[64];
    }
