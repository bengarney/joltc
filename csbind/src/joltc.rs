...
extern "C" {
    pub fn JPH_BodyLockInterface_TryGetBody(
        lockInterface: *const JPH_BodyLockInterface,
        bodyID: u32,
    ) -> *mut JPH_Body;
}
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct JPH_CollisionEstimationResult {
    #[doc = "< The estimated linear velocity of body 1 after collision"]
    pub mLinearVelocity1: JPH_Vec3,
    #[doc = "< The estimated angular velocity of body 1 after collision"]
    pub mAngularVelocity1: JPH_Vec3,
    #[doc = "< The estimated linear velocity of body 2 after collision"]
    pub mLinearVelocity2: JPH_Vec3,
    #[doc = "< The estimated angular velocity of body 2 after collision"]
    pub mAngularVelocity2: JPH_Vec3,
    #[doc = "< Normalized tangent of contact normal"]
    pub mTangent1: JPH_Vec3,
    #[doc = "< Second normalized tangent of contact normal (forms a basis with mTangent1 and mWorldSpaceNormal)"]
    pub mTangent2: JPH_Vec3,
    pub ImpulseCount: ::std::os::raw::c_int,
    pub ContactImpulse: [f32; 64usize],
    pub FrictionImpulse1: [f32; 64usize],
    pub FrictionImpulse2: [f32; 64usize],
}
#[test]
fn bindgen_test_layout_JPH_CollisionEstimationResult() {
    const UNINIT: ::std::mem::MaybeUninit<JPH_CollisionEstimationResult> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<JPH_CollisionEstimationResult>(),
        844usize,
        concat!("Size of: ", stringify!(JPH_CollisionEstimationResult))
    );
    assert_eq!(
        ::std::mem::align_of::<JPH_CollisionEstimationResult>(),
        4usize,
        concat!("Alignment of ", stringify!(JPH_CollisionEstimationResult))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mLinearVelocity1) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(JPH_CollisionEstimationResult),
            "::",
            stringify!(mLinearVelocity1)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mAngularVelocity1) as usize - ptr as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(JPH_CollisionEstimationResult),
            "::",
            stringify!(mAngularVelocity1)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mLinearVelocity2) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(JPH_CollisionEstimationResult),
            "::",
            stringify!(mLinearVelocity2)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mAngularVelocity2) as usize - ptr as usize },
        36usize,
        concat!(
            "Offset of field: ",
            stringify!(JPH_CollisionEstimationResult),
            "::",
            stringify!(mAngularVelocity2)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mTangent1) as usize - ptr as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(JPH_CollisionEstimationResult),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mTangent2) as usize - ptr as usize },
        60usize,
        concat!(
            "Offset of field: ",
            stringify!(JPH_CollisionEstimationResult),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ImpulseCount) as usize - ptr as usize },
        72usize,
        concat!(
            "Offset of field: ",
            stringify!(JPH_CollisionEstimationResult),
            "::",
            stringify!(ImpulseCount)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ContactImpulse) as usize - ptr as usize },
        76usize,
        concat!(
            "Offset of field: ",
            stringify!(JPH_CollisionEstimationResult),
            "::",
            stringify!(ContactImpulse)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).FrictionImpulse1) as usize - ptr as usize },
        332usize,
        concat!(
            "Offset of field: ",
            stringify!(JPH_CollisionEstimationResult),
            "::",
            stringify!(FrictionImpulse1)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).FrictionImpulse2) as usize - ptr as usize },
        588usize,
        concat!(
            "Offset of field: ",
            stringify!(JPH_CollisionEstimationResult),
            "::",
            stringify!(FrictionImpulse2)
        )
    );
}
extern "C" {
    pub fn JPH_EstimateCollisionResponse(
        a: *mut JPH_Body,
        b: *mut JPH_Body,
        ...
        inNumIterations: ::std::os::raw::c_int,
    );
}
